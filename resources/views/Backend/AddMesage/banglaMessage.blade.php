...
<div>
    <p class="text-xl text-center text-red-500">প্রতি ৬০ টি ওয়ার্ডের জন্য একটি করে মেসেজ কাউন্ট করা হবে</p>
</div>
<div class="mx-5 mt-10 border border-dashed p-5">
    <form action="{{ route('post.message') }}" method="post">
        ...
        <div class="mt-5 relative">
            ...
            <textarea id="message" name="message" class="textarea textarea-bordered w-full bg-[#09605A1A] text-black mt-3 lg:h-[500px]" oninput="countCharacters()"></textarea>
...
<script>
    function countCharacters() {
        ...
        const numMessages = Math.ceil(characterCount / 65);
        document.getElementById('wordCount').innerText = `${numMessages} message${numMessages > 1 ? 's' : ''}`;
        document.getElementById('message_count').value = numMessages; 
    }
</script>
@endsection
